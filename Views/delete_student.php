...
<h2 class="text-primary"> DELETE STUDENT</h2><p>  </p></div>
...
<form action="<?php echo htmlspecialchars("?page=delete_student");?>" method="post" role="form">

<div class="form-group">

<label for="delete"> Enter the Addmission Number of the Student to be  Deleted  </label>
...
<form action="."?page=delete_student"." method="."post"." role="."form".">


<div class="."form-group".">

<button type="."submit"." name="."Delete"." class="."btn-danger btn btn-group-lg". "> Delete Student </button>
